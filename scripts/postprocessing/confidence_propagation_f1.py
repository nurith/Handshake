...
def sweep(df, contact_matrices=None):
    print("\nSweeping parameters...")
    high_thresholds    = [0.50, 0.55, 0.60, 0.65]
    mid_thresholds     = [0.35, 0.40, 0.45, 0.50, 0.55]
    min_neighbours_l   = [1, 2, 3, 4]
    windows            = [2, 3, 5,7,10]
    contact_thresholds = [0.30, 0.40, 0.50, 0.60] if contact_matrices else [None]
